...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = KEYMAP( \
      ...
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, KC_ESC,  LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_RGUI, KC_LEFT, KC_MINS, KC_PLUS, KC_PIPE \
      ),
  ...
  [_LOWER] = KEYMAP( \
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_UNDS, KC_EQL,  KC_BSLS \
      ),
