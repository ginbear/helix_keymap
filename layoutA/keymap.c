...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = KEYMAP( \
      ...
      LOWER,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT , \
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, KC_LGUI, KC_ESC,  KC_SPC,  KC_ENT,  RAISE,   KC_RGUI, KC_LEFT, KC_UNDS, KC_EQL,  KC_BSLS \
      ),
  ...
  [_LOWER] = KEYMAP( \
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_MINS, KC_PLUS, KC_PIPE\
      ),
  ...
  [_RAISE] = KEYMAP( \
      ...
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL, \
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_LEFT, KC_DOWN, KC_UP,   KC_DOWN, KC_RBRC, KC_BSLS, \
